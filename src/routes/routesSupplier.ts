...
import { getSupplier, addSupplier, editSupplier, getSupplierProducts } from "../controller/controllerSupplier";
...
router.route("/deleteSupplier/sId/:sId").delete(protect, editSupplier);
